...
.DESCRIPTION
The Get-PrtgCommand retrieves all commands that are available for use within the
PrtgAPI Build Environment. Each command contains a description outlining what exactly
that command does. The results from Get-PrtgCommand can be filtered by specifying a wildcard
expression matching part of the command's name you wish to find.
